...
public class SampleDataLoader {
    ...
    private final List<Classroom> classrooms = List.of(
    ...
    private final List<Student> students = List.of(
            new Student("John", "Doe", "Smith", LocalDate.of(2000, 5, 15), LocalDate.of(2010, 9, 1), (short) 2022),
            new Student("Alice", "Johnson", "Brown", LocalDate.of(2001, 8, 12), LocalDate.of(2011, 7, 20), (short) 2023),
            new Student("Robert", "Williams", "Davis", LocalDate.of(1999, 4, 7), LocalDate.of(2009, 11, 14), (short) 2022),
            new Student("Eva", "Martinez", "Wilson", LocalDate.of(2002, 2, 3), LocalDate.of(2012, 5, 18), (short) 2024),
            new Student("Michael", "Harris", "Taylor", LocalDate.of(1998, 10, 25), LocalDate.of(2008, 12, 10), (short) 2021),
            new Student("Sarah", "Lee", "Anderson", LocalDate.of(2003, 7, 9), LocalDate.of(2013, 8, 2), (short) 2025),
            new Student("Daniel", "Clark", "White", LocalDate.of(1997, 1, 12), LocalDate.of(2007, 3, 22), (short) 2021),
            new Student("Emily", "Adams", "Moore", LocalDate.of(2000, 6, 20), LocalDate.of(2010, 9, 1), (short) 2022),
            new Student("James", "Turner", "Collins", LocalDate.of(2001, 9, 15), LocalDate.of(2011, 7, 20), (short) 2023),
            new Student("Olivia", "Carter", "Parker", LocalDate.of(1999, 3, 18), LocalDate.of(2009, 11, 14), (short) 2022),
            new Student("Benjamin", "Murphy", "Lewis", LocalDate.of(2002, 4, 7), LocalDate.of(2012, 5, 18), (short) 2024),
            new Student("Ava", "Hall", "Cooper", LocalDate.of(1998, 8, 3), LocalDate.of(2008, 12, 10), (short) 2021)
    );
